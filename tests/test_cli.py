...
def test_init_creates_files(tmp_path: Path):
    ...
    assert (tmp_path / ".claude/skills/analyze-job-run/references/glue-errors.md").exists()
    assert (tmp_path / ".claude/skills/analyze-job-run/references/company-errors.md").exists()
