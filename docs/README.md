...
| [configuration.md](configuration.md) | Variáveis de ambiente, profiles por conta, região e contas sandbox. |
...
| [security.md](security.md) | Trava de sandbox (fail-closed), credenciais e higiene de segredos. |
